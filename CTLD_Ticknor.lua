...
ctld.JTAC_LIMIT_RED = 50 -- max number of JTAC Crates for the RED Side
ctld.JTAC_LIMIT_BLUE = 50 -- max number of JTAC Crates for the BLUE Side
...
ctld.transportPilotNames = {
    ...
    "SA342Mistral Kutaisi [1]",
    "SA342Mistral Kutaisi [2]",
    "SA342Mistral Kutaisi [3]",
    "UH-1H Kutaisi [1]",
    "UH-1H Kutaisi [2]",
    "UH-1H Kutaisi [3]",
    "UH-1H Kutaisi [4]",
...
ctld.loadableGroups = {
    {name = "Standard Group", inf = 4, mg = 2, at = 1 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
...
function ctld.destroyCrate(_name)
    local _transUnit = ctld.getTransportUnit(_name)

    if _transUnit ~= nil  then

        if ctld.inAir(_transUnit) then
            ctld.displayMessageToGroup(_transUnit, "You must land before you can destroy a crate!", 10,true)
            return
        end
        ...
        if ctld.inTransitSlingLoadCrates[_name] == nil then
            ...
            for _, _crate in pairs(_crates) do
                ...
                if _crate.dist < 50.0 then
                    ctld.displayMessageToGroup(_transUnit, "Destroyed  " .. _crate.details.desc .. " crate!", 10,true)
                ...
                if _groupId then
                    ...
                    if ctld.addedTo[tostring(_groupId)] == nil then
                        ...
                        if (ctld.enabledFOBBuilding or ctld.enableCrates) and _unitActions.crates then
							...
							missionCommands.addCommandForGroup(_groupId, "Destroy Nearest Crate", _crateCommands, ctld.destroyCrate,  _unitName ) --added this Ticknor.D
        ...
        -- for _, _playerUnit in pairs(_players) do
            ...
            -- if _groupId then
                ...
                -- if ctld.jtacRadioAdded[tostring(_groupId)] == nil then
                    ...
                    -- missionCommands.addCommandForGroup(_groupId, "CTLD JTAC Status", nil, ctld.getJTACStatus, { _playerUnit:getName() })
